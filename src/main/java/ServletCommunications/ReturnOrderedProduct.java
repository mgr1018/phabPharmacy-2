...
public class ReturnOrderedProduct {
    ...
    public ReturnOrderedProduct(int id){
        String message = String.valueOf(id);
        byte[] body = message.getBytes(StandardCharsets.UTF_8);
        URL myURL = null;
        try {
            myURL = new URL("https://phabbackend.herokuapp.com/onlineorders");
...
// Read the body of the response
            while ((inputLine = bufferedReader.readLine()) != null) {
                ...
                //OnlineOrdersSize s2 = new OnlineOrdersSize();
